...
def _render_analysis_section_navigation(*, analysis_id: str) -> str:
    ...
    area_clicked, more_clicked = render_saved_bom_section_nav(
    ...
    if area_clicked:
        st.session_state[area_key] = area_clicked
        st.session_state[more_key] = "More"
        st.rerun()
    if more_clicked:
        st.session_state[more_key] = more_clicked
        more_choice = more_clicked
        st.rerun()
...
def render_analysis_detail(
    *,
    ...
    st.markdown(
        ...
        button[data-baseweb="tab"]{border:1px solid transparent!important;border-radius:10px 10px 0 0!important;padding:10px 16px 12px!important;font-weight:650!important;color:#334155!important;background:transparent!important}
        button[data-baseweb="tab"]:hover{background:#f8fbff!important;color:#0b1220!important}
        ...
        [data-testid="stTabs"]{margin-top:8px}[data-testid="stTabs"] [data-baseweb="tab-list"]{position:sticky;top:64px;z-index:40;background:#fff;border:0;border-bottom:1px solid #d7e2ef;border-radius:0;padding:0;box-shadow:none;gap:4px}[data-testid="stTabs"] [data-baseweb="tab"]{height:42px;border-radius:10px 10px 0 0;padding:0 18px;font-weight:650;color:#334155;background:transparent}[data-testid="stTabs"] [aria-selected="true"]{background:#eff6ff!important;color:#1d4ed8!important;box-shadow:inset 0 -3px 0 #2563eb!important}
