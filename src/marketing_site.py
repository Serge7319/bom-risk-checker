...
def _legal_page(kind: str) -> None:
    ...
    if kind == "security":
        ...
        <h2>10. Contact</h2>
        <p>Questions about these Terms may be sent to <strong>legal@cadivor.com</strong> with “Terms” in the subject line.</p>
