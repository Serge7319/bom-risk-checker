      ...
      <section class="cv634-hero">
        <div class="mk-wide cv634-hero-grid">
          <div class="cv634-copy">
            ...
            <h1>Turn BOM risk into <span>defensible engineering decisions.</span></h1>
          ...
          <div class="cv634-product" aria-label="Animated Cadivor BOM-to-decision product demonstration">
            ...
            <div class="cv634-demo-caption"><span class="s1">Importing BOM</span><span class="s2">Analyzing 1,842 components</span><span class="s3">Finding release blockers</span><span class="s4">Generating recommendation</span><span class="s5">Recording approved decision</span></div>
          </div>
        </div>
      </section>
...
def _sprint_63_4_product_led_css() -> None:
    ...
    .cv634-story *{box-sizing:border-box}.cv634-hero{position:relative;padding:74px 0 82px;background:radial-gradient(circle at 83% 8%,rgba(65,126,245,.19),transparent 31%),linear-gradient(145deg,#06142c 0%,#091b39 60%,#0d2853 100%);color:#fff;overflow:hidden}.cv634-hero-grid{display:grid;grid-template-columns:minmax(380px,.74fr) minmax(720px,1.45fr);gap:58px;align-items:center}.cv634-copy h1{max-width:690px;margin:22px 0 22px;color:#fff!important;font-size:clamp(48px,5.1vw,78px);line-height:.99;letter-spacing:-.055em}.cv634-copy h1 span{color:#78a9ff}.cv634-copy>p{max-width:650px;margin:0;color:#c9d7eb!important;font-size:18px;line-height:1.7}.cv634-copy .mk-actions{margin:31px 0 20px}.cv634-copy .mk-btn-ghost{border-color:rgba(255,255,255,.28)!important;color:#fff!important}.cv634-proof{display:flex;flex-wrap:wrap;gap:9px 18px;color:#aebed4;font-size:12px;font-weight:700}.cv634-product{position:relative;min-width:0;border:1px solid rgba(143,180,242,.32);border-radius:20px;background:#fff;box-shadow:0 40px 100px rgba(0,0,0,.36);overflow:hidden;transform:perspective(1500px) rotateY(-1.6deg)}.cv634-windowbar{height:48px;padding:0 16px;display:flex;align-items:center;gap:14px;background:#edf2f8;border-bottom:1px solid #d7e0eb;color:#526379;font-size:10px}.cv634-windowbar>b{flex:1}.cv634-windowbar em{display:flex;align-items:center;gap:7px;color:#2463d4;font-style:normal;font-weight:850}.cv634-windowbar em i{width:7px;height:7px;border-radius:50%;background:#1dad6b;animation:cv634-pulse 1.8s infinite}.cv634-dots{display:flex;gap:5px}.cv634-dots i{width:8px;height:8px;border-radius:50%;background:#c8d2df}.cv634-dots i:first-child{background:#f06b68}.cv634-dots i:nth-child(2){background:#efbc53}.cv634-dots i:nth-child(3){background:#59bf7b}.cv634-app{display:grid;grid-template-columns:88px 1fr;min-height:550px}.cv634-app aside{padding:16px 9px;background:#081a37;color:#9fb0c8;display:flex;flex-direction:column;gap:8px}.cv634-app aside strong{width:32px;height:32px;margin:0 auto 9px;border-radius:9px;background:#2f6df6;display:grid;place-items:center;color:#fff;font-size:17px}.cv634-app aside span{padding:8px 5px;border-radius:7px;text-align:center;font-size:8px;font-weight:750}.cv634-app aside span.active{background:#173867;color:#fff}.cv634-canvas{padding:19px;background:#f6f8fb;min-width:0}.cv634-stage-label{display:flex;align-items:center;gap:12px}.cv634-stage-label>span{font-size:8px;letter-spacing:.1em;color:#7a899c;font-weight:850;text-transform:uppercase}.cv634-stage-label>b{flex:1;color:#10213d;font-size:15px}.cv634-stage-label em{padding:6px 9px;border-radius:999px;background:#fff3db;color:#b26a08;font-size:8px;font-style:normal;font-weight:900}.cv634-progress{position:relative;display:grid;grid-template-columns:repeat(5,1fr);gap:0;margin:16px 0 13px;padding-top:9px}.cv634-progress::before{content:"";position:absolute;left:7%;right:7%;top:2px;height:3px;border-radius:999px;background:#dce4ee}.cv634-progress i{position:absolute;left:7%;top:2px;height:3px;width:0;border-radius:999px;background:#2f6df6;animation:cv634-progress 16s ease-in-out infinite}.cv634-progress span{text-align:center;color:#7a899c;font-size:7px;font-weight:800}.cv634-file{display:flex;align-items:center;gap:10px;padding:10px 12px;border:1px solid #dae3ee;border-radius:10px;background:#fff}.cv634-file>div{width:29px;height:29px;border-radius:8px;background:#e8f0ff;display:grid;place-items:center;color:#2f6df6}.cv634-file svg,.cv634-copilot-head svg,.cv634-insight header svg,.cv634-pipeline svg{width:16px;height:16px;fill:none;stroke:currentColor;stroke-width:1.8}.cv634-file span{display:flex;flex:1;flex-direction:column}.cv634-file b{font-size:9px;color:#172a47}.cv634-file small{font-size:7px;color:#7a899c}.cv634-file em{font-size:7px;font-style:normal;font-weight:850;color:#169b62}.cv634-kpis{display:grid;grid-template-columns:repeat(4,1fr);gap:8px;margin:10px 0}.cv634-kpis article{padding:10px;border:1px solid #dce4ee;border-radius:9px;background:#fff}.cv634-kpis small{display:block;color:#718096;font-size:7px}.cv634-kpis strong{display:block;margin:2px 0;color:#0b1c37;font-size:18px}.cv634-health,.cv634-blockers,.cv634-alerts,.cv634-alts{font-size:0!important}.cv634-health::after,.cv634-blockers::after,.cv634-alerts::after,.cv634-alts::after{font-size:18px}.cv634-health::after{content:"—";animation:cv634-health 16s infinite}.cv634-blockers::after{content:"—";animation:cv634-blockers 16s infinite}.cv634-alerts::after{content:"—";animation:cv634-alerts 16s infinite}.cv634-alts::after{content:"—";animation:cv634-alts 16s infinite}.cv634-posture{animation:cv634-posture 16s infinite}.cv634-kpis span{font-size:7px;color:#8190a3}.cv634-workarea{display:grid;grid-template-columns:1.08fr .92fr;gap:10px}.cv634-risks,.cv634-insight{border:1px solid #dce4ee;border-radius:10px;background:#fff;overflow:hidden}.cv634-risks header,.cv634-insight header{padding:10px 11px;border-bottom:1px solid #e4eaf1;display:flex;justify-content:space-between;align-items:center}.cv634-risks header b,.cv634-insight header span{color:#17304f;font-size:9px;font-weight:850}.cv634-risks header span,.cv634-insight header em{font-size:7px;color:#78879a;font-style:normal}.cv634-risk{display:grid;grid-template-columns:22px 1fr auto;gap:8px;align-items:center;padding:9px 11px;border-bottom:1px solid #edf1f5;opacity:.2;transform:translateX(-8px)}.cv634-risk i{width:20px;height:20px;border-radius:6px;display:grid;place-items:center;background:#f2f5f9;color:#53657a;font-size:7px;font-style:normal;font-weight:900}.cv634-risk span{display:flex;flex-direction:column}.cv634-risk b{font-size:8px;color:#162942}.cv634-risk small{font-size:7px;color:#77869a}.cv634-risk em{font-size:7px;font-style:normal;font-weight:850;color:#c13a41}.cv634-risk.r1{animation:cv634-risk-in 16s 3.4s infinite}.cv634-risk.r2{animation:cv634-risk-in 16s 4.2s infinite}.cv634-risk.r3{animation:cv634-risk-in 16s 5s infinite}.cv634-question{margin:10px!important;padding:8px 9px;border-radius:8px;background:#edf3fc;color:#294769!important;font-size:8px!important}.cv634-answer{margin:8px 10px;padding:10px;border-radius:8px;background:#0d2447;color:#fff;opacity:0;animation:cv634-answer 16s 7s infinite}.cv634-answer b,.cv634-answer span,.cv634-answer small{display:block}.cv634-answer b{font-size:9px}.cv634-answer span{margin:4px 0;color:#dbe8f8;font-size:7px;line-height:1.45}.cv634-answer small{color:#8fb5ee;font-size:6px}.cv634-decision{margin:8px 10px;padding:9px;border:1px solid #cce8da;border-radius:8px;background:#effaf5;display:flex;flex-direction:column;opacity:0;animation:cv634-decision-in 16s 10.4s infinite}.cv634-decision span{font-size:6px;color:#678175}.cv634-decision b{font-size:8px;color:#11643f}.cv634-decision em{font-size:6px;color:#169b62;font-style:normal}.cv634-demo-caption{position:absolute;left:50%;bottom:12px;transform:translateX(-50%);min-width:225px;height:26px;padding:0 12px;border:1px solid rgba(133,174,239,.22);border-radius:999px;background:rgba(6,20,44,.93);color:#d8e6fa;overflow:hidden}.cv634-demo-caption span{position:absolute;inset:0;display:grid;place-items:center;font-size:8px;font-weight:800;opacity:0}.cv634-demo-caption .s1{animation:cv634-caption 16s 0s infinite}.cv634-demo-caption .s2{animation:cv634-caption 16s 2.6s infinite}.cv634-demo-caption .s3{animation:cv634-caption 16s 5.2s infinite}.cv634-demo-caption .s4{animation:cv634-caption 16s 7.8s infinite}.cv634-demo-caption .s5{animation:cv634-caption 16s 10.4s infinite}
    ...
    @keyframes cv634-health{0%,16%{content:"—"}24%,92%{content:"72"}100%{content:"—"}}@keyframes cv634-blockers{0%,23%{content:"—"}31%,92%{content:"2"}100%{content:"—"}}@keyframes cv634-alerts{0%,28%{content:"—"}36%,92%{content:"7"}100%{content:"—"}}@keyframes cv634-alts{0%,34%{content:"—"}42%,92%{content:"18"}100%{content:"—"}}@keyframes cv634-posture{0%,18%{color:#b26a08;background:#fff3db}19%,48%{color:#b26a08;background:#fff3db}49%,68%{color:#c13a41;background:#fff0f1}69%,100%{color:#14834f;background:#e9f8f0}}@keyframes cv634-pulse{0%{box-shadow:0 0 0 0 rgba(29,173,107,.45)}70%{box-shadow:0 0 0 7px rgba(29,173,107,0)}100%{box-shadow:0 0 0 0 rgba(29,173,107,0)}}@keyframes cv634-progress{0%,5%{width:0}18%{width:21%}36%{width:43%}56%{width:64%}76%,94%{width:86%}100%{width:0}}@keyframes cv634-risk-in{0%,18%{opacity:.2;transform:translateX(-8px)}26%,83%{opacity:1;transform:none}95%,100%{opacity:.2;transform:translateX(-8px)}}@keyframes cv634-answer{0%,40%{opacity:0;transform:translateY(5px)}49%,84%{opacity:1;transform:none}94%,100%{opacity:0;transform:translateY(5px)}}@keyframes cv634-decision-in{0%,62%{opacity:0;transform:translateY(5px)}70%,91%{opacity:1;transform:none}100%{opacity:0;transform:translateY(5px)}}@keyframes cv634-caption{0%,16%{opacity:0;transform:translateY(5px)}20%,32%{opacity:1;transform:none}36%,100%{opacity:0;transform:translateY(-5px)}}@keyframes cv634-flow{0%{transform:translateX(0)}50%{transform:translateX(355%)}100%{transform:translateX(0)}}@keyframes cv634-retrieve{0%{background-size:0 100%}60%,100%{background-size:100% 100%}}
    @media(max-width:1250px){.cv634-hero-grid{grid-template-columns:1fr}.cv634-product{transform:none}.cv634-command-grid,.cv634-split,.cv634-decision-grid{grid-template-columns:1fr}.cv634-split,.cv634-decision-grid{gap:45px}}@media(max-width:900px){.cv634-pipeline{grid-template-columns:repeat(2,1fr)}.cv634-flowline{display:none}.cv634-supplier-table{overflow-x:auto}.cv634-supplier-table header,.cv634-supplier-table>div{min-width:820px}.cv634-supplier-kpis{grid-template-columns:repeat(2,1fr)}.cv634-record-meta{grid-template-columns:1fr}.cv634-record-meta>div{border-right:0;border-bottom:1px solid #e1e8ef}}@media(max-width:650px){.cv634-hero{padding:52px 0}.cv634-copy h1{font-size:46px}.cv634-app{grid-template-columns:1fr}.cv634-app aside{display:none}.cv634-kpis{grid-template-columns:repeat(2,1fr)}.cv634-workarea{grid-template-columns:1fr}.cv634-product{overflow:visible}.cv634-pipeline{grid-template-columns:1fr}.cv634-command-metrics,.cv634-supplier-kpis{grid-template-columns:1fr}.cv634-exposure>div{grid-template-columns:110px 1fr 45px}.cv634-coverage .mk-wrap{flex-wrap:wrap;gap:18px;padding:18px 0}.cv634-section{padding:78px 0}.cv634-supplier-action{align-items:flex-start;flex-direction:column}.cv634-demo-caption{display:none}}
    @media(prefers-reduced-motion:reduce){.cv634-story *{animation:none!important;transition:none!important}.cv634-risk,.cv634-answer,.cv634-decision{opacity:1!important;transform:none!important}.cv634-health::after{content:"72"}.cv634-product{transform:none}}
    </style>
    """, unsafe_allow_html=True)
