      ...
      <section class="cv634-hero">
        <div class="mk-wide cv634-hero-grid">
          <div class="cv634-copy">
            ...
            <div class="cv634-proof"><span>✓ No credit card</span><span>✓ CSV and Excel BOMs</span><span>✓ Evidence-linked recommendations</span></div>
          </div>
          <div class="cv634-product" aria-label="Animated Cadivor BOM-to-decision product demonstration">
            ...
            <div class="cv634-app">
              ...
              <div class="cv634-canvas">
                ...
                <div class="cv634-file"><div>{_icon('bom')}</div><span><b>motor_controller_rev_c.xlsx</b><small>1,842 components · 36 suppliers</small></span><em>Imported</em></div>
