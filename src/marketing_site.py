    ...
    <main class="mk-shell mk-launch-story">
      <section class="mk-hero mk-launch-hero"><div class="mk-wide mk-launch-hero-grid">
        <div class="mk-launch-copy">
          ...
          <h1>Know what can stop production <span class="mk-accent">before it does.</span></h1>
          <p class="mk-hero-copy">Cadivor turns a BOM into an evidence-backed engineering review—combining lifecycle risk, supplier intelligence, qualified alternatives, AI guidance, monitoring, and accountable decisions in one workspace.</p>
        ...
        <div class="mk-demo-stage" aria-label="Cadivor product demo container">
          <div class="mk-demo-frame">
            <div class="mk-demo-toolbar"><span class="mk-demo-dots"><i></i><i></i><i></i></span><span>Motor Controller Rev C · Engineering Review</span><em>Demo-ready media container</em></div>
            ...
            <div class="mk-media-slot"><span>Drop a looping MP4/WebM here later</span></div>
          </div>
        </div>
      </div></section>
      ...
      <section class="mk-section mk-workflow-section" id="workflow"><div class="mk-wrap"><div class="mk-heading"><div class="mk-kicker">The engineering workflow</div><h2>One connected path from BOM upload to release decision.</h2><p>Every step adds context and evidence, so engineering, procurement, and supply chain can act from the same review.</p></div><div class="mk-workflow-grid">
        <article><span>01</span><div class="mk-icon">{_icon('bom')}</div><h3>Upload BOM</h3><p>Import CSV or Excel files and normalize manufacturer part numbers, quantities, and product context.</p></article>
        <article><span>02</span><div class="mk-icon">{_icon('portfolio')}</div><h3>Analyze Risk</h3><p>Surface lifecycle, stock, lead-time, supplier concentration, cost, and sourcing exposure.</p></article>
        <article><span>03</span><div class="mk-icon">{_icon('chat')}</div><h3>AI Copilot</h3><p>Ask what matters first, challenge recommendations, and trace every conclusion to supporting evidence.</p></article>
        <article><span>04</span><div class="mk-icon">{_icon('decision')}</div><h3>Engineering Decision</h3><p>Approve, reject, assign, monitor, and preserve the rationale behind the release decision.</p></article>
      </div></div></section>
