...
def _footer() -> None:
    ...
    <footer class="mk-footer"><div class="mk-wrap">
      <div class="mk-footer-grid">
        <div class="mk-footer-brand"><button type="button" class="mk-brand" data-cv-public="home"><span class="mk-logo">C</span>Cadivor</button><p>Engineering intelligence that helps hardware teams understand BOM risk, evaluate alternatives, and make better decisions before production.</p></div>
        <div class="mk-footer-col"><strong>Product</strong><button type="button" data-cv-public="product">Overview</button><button type="button" data-cv-public="product">Engineering Intelligence</button><button type="button" data-cv-public="product">Ask Cadivor</button><button type="button" data-cv-public="pricing">Pricing</button></div>
        <div class="mk-footer-col"><strong>Solutions</strong><button type="button" data-cv-public="solutions">Robotics</button><button type="button" data-cv-public="solutions">Medical Devices</button><button type="button" data-cv-public="solutions">Industrial Automation</button><button type="button" data-cv-public="solutions">Hardware Startups</button></div>
        <div class="mk-footer-col"><strong>Resources</strong><button type="button" data-cv-public="resources">Getting Started</button><button type="button" data-cv-public="resources">Demo BOMs</button><button type="button" data-cv-public="resources">Engineering Guides</button><button type="button" data-cv-public="resources">FAQ</button></div>
        <div class="mk-footer-col"><strong>Company</strong><button type="button" data-cv-public="company">About</button><button type="button" data-cv-public="security">Security</button><button type="button" data-cv-public="contact">Contact</button><button type="button" data-cv-public="privacy">Privacy</button><button type="button" data-cv-public="terms">Terms</button></div><div class="mk-footer-col"><strong>Data coverage</strong><span>DigiKey</span><span>Mouser</span><span>Newark</span><span>Octopart — Coming soon</span></div>
      </div>
...
def _home() -> None:
    ...
    <main class="mk-shell">
      ...
      <section class="mk-section"><div class="mk-wrap"><div class="mk-heading"><div class="mk-kicker">The Cadivor platform</div><h2>Everything you need to manage engineering and supply-chain risk</h2><p>From first BOM upload through release, monitoring, and audit-ready decisions, Cadivor keeps the full engineering review connected.</p></div><div class="mk-card-grid eight">
        <div class="mk-card"><div class="mk-icon">{_icon('bom')}</div><h3>BOM & Supply-Chain Intelligence</h3><p>Analyze lifecycle, availability, lead-time, supplier concentration, sourcing resilience, and supply-chain exposure across every component.</p><button type="button" data-cv-public="product">Learn more →</button></div>
        <div class="mk-card"><div class="mk-icon">{_icon('brain')}</div><h3>Engineering Intelligence</h3><p>Turn risk signals into prioritized conclusions, evidence, and release-oriented recommendations.</p><button type="button" data-cv-public="product">Learn more →</button></div>
        <div class="mk-card"><div class="mk-icon">{_icon('chat')}</div><h3>Ask Cadivor</h3><p>Ask natural-language questions about the active BOM and challenge recommendations with evidence.</p><button type="button" data-cv-public="product">Learn more →</button></div>
        <div class="mk-card"><div class="mk-icon">{_icon('compare')}</div><h3>Alternative Finder</h3><p>Compare replacement candidates with lifecycle, sourcing, and implementation context.</p><button type="button" data-cv-public="product">Learn more →</button></div>
        <div class="mk-card"><div class="mk-icon">{_icon('monitor')}</div><h3>Continuous Monitoring</h3><p>Track critical components and surface lifecycle, stock, and supplier changes early.</p><button type="button" data-cv-public="product">Learn more →</button></div>
        <div class="mk-card"><div class="mk-icon">{_icon('decision')}</div><h3>Engineering Decisions</h3><p>Approve, reject, assign, and document decisions with rationale and review history.</p><button type="button" data-cv-public="product">Learn more →</button></div>
        <div class="mk-card"><div class="mk-icon">{_icon('report')}</div><h3>Executive Reports</h3><p>Generate decision-ready summaries, lifecycle reports, and engineering evidence packages.</p><button type="button" data-cv-public="product">Learn more →</button></div>
        <div class="mk-card"><div class="mk-icon">{_icon('portfolio')}</div><h3>Portfolio Intelligence</h3><p>See risk exposure, monitored parts, trends, and priority actions across product programs.</p><button type="button" data-cv-public="product">Learn more →</button></div>
      </div></div></section>
