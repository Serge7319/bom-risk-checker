...
PLANS = {
    "Student": {"monthly_bom_limit": 10, "max_parts_per_bom": 100, "max_saved_boms": 25, "monitored_parts_limit": 0, "team_features": False, "api_access": False, "student_watermark": True, "price": "$0", "upgrade_to": "Professional", "description": "For verified students and academic projects."},
    "Trial": {"monthly_bom_limit": UNLIMITED, "max_parts_per_bom": UNLIMITED, "max_saved_boms": UNLIMITED, "monitored_parts_limit": UNLIMITED, "team_features": True, "api_access": True, "student_watermark": False, "price": "$0 for 14 days", "upgrade_to": "Professional", "description": "Full Cadivor access for 14 days."},
    "Starter": {"monthly_bom_limit": 10, "max_parts_per_bom": 100, "max_saved_boms": 100, "monitored_parts_limit": 0, "team_features": False, "api_access": False, "student_watermark": False, "price": "$29/mo", "upgrade_to": "Professional", "description": "For individual prototype and early production reviews."},
    "Professional": {"monthly_bom_limit": UNLIMITED, "max_parts_per_bom": UNLIMITED, "max_saved_boms": UNLIMITED, "monitored_parts_limit": 2500, "team_features": False, "api_access": False, "student_watermark": False, "price": "$99/mo", "upgrade_to": "Business", "description": "For professional engineers and growing hardware teams."},
    "Business": {"monthly_bom_limit": UNLIMITED, "max_parts_per_bom": UNLIMITED, "max_saved_boms": UNLIMITED, "monitored_parts_limit": UNLIMITED, "team_features": True, "api_access": True, "student_watermark": False, "price": "$299/mo", "upgrade_to": "Enterprise", "description": "For teams standardizing engineering decisions."},
    "Enterprise": {"monthly_bom_limit": UNLIMITED, "max_parts_per_bom": UNLIMITED, "max_saved_boms": UNLIMITED, "monitored_parts_limit": UNLIMITED, "team_features": True, "api_access": True, "student_watermark": False, "price": "Custom", "upgrade_to": None, "description": "For secure, integrated, organization-wide deployments."},
}
