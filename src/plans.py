...
PLANS = {
    "Student": {"ai_credits": 20, "monthly_bom_limit": 10, "max_parts_per_bom": 100, "max_saved_boms": 25, "monitored_parts_limit": 0, "team_features": False, "api_access": False, "student_watermark": True, "price": "$0", "upgrade_to": "Professional", "description": "For verified students and academic projects."},
    ...
    "Starter": {"ai_credits": 30, "monthly_bom_limit": 10, "max_parts_per_bom": 100, "max_saved_boms": 100, "monitored_parts_limit": 0, "team_features": False, "api_access": False, "student_watermark": False, "price": "$29/mo", "upgrade_to": "Professional", "description": "For individual prototype and early production reviews."},
    ...
    "Business": {"ai_credits": 2500, "monthly_bom_limit": UNLIMITED, "max_parts_per_bom": UNLIMITED, "max_saved_boms": UNLIMITED, "monitored_parts_limit": UNLIMITED, "team_features": True, "api_access": True, "student_watermark": False, "price": "$299/mo", "upgrade_to": "Enterprise", "description": "For teams standardizing engineering decisions."},
    "Enterprise": {"ai_credits": 10000, "monthly_bom_limit": UNLIMITED, "max_parts_per_bom": UNLIMITED, "max_saved_boms": UNLIMITED, "monitored_parts_limit": UNLIMITED, "team_features": True, "api_access": True, "student_watermark": False, "price": "Custom", "upgrade_to": None, "description": "For secure, integrated, organization-wide deployments."},
}
