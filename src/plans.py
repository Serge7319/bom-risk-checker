...
PLANS = {
    "Student": {"ai_credits": 0, "monthly_bom_limit": 5, "max_parts_per_bom": 50, "max_saved_boms": 25, "monitored_parts_limit": 0, "team_features": False, "api_access": False, "datasheet_comparison": False, "student_watermark": True, "price": "$0", "upgrade_to": "Professional", "description": "For verified students and academic projects."},
    "Trial": {"ai_credits": 100, "monthly_bom_limit": UNLIMITED, "max_parts_per_bom": UNLIMITED, "max_saved_boms": UNLIMITED, "monitored_parts_limit": UNLIMITED, "team_features": True, "api_access": True, "datasheet_comparison": True, "student_watermark": False, "price": "$0 for 14 days", "upgrade_to": "Professional", "description": "Full Cadivor access for 14 days."},
    "Starter": {"ai_credits": 0, "monthly_bom_limit": 10, "max_parts_per_bom": 100, "max_saved_boms": 100, "monitored_parts_limit": 0, "team_features": False, "api_access": False, "datasheet_comparison": False, "student_watermark": False, "price": "$29/mo", "upgrade_to": "Professional", "description": "For individual prototype and early production reviews."},
    "Professional": {"ai_credits": 500, "monthly_bom_limit": UNLIMITED, "max_parts_per_bom": UNLIMITED, "max_saved_boms": UNLIMITED, "monitored_parts_limit": 2500, "team_features": False, "api_access": False, "datasheet_comparison": True, "student_watermark": False, "price": "$99/mo", "upgrade_to": "Business", "description": "For professional engineers and growing hardware teams."},
