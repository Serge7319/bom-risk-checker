...
PLANS = {
    "Student": {"ai_credits": 0, "monthly_bom_limit": 5, "max_parts_per_bom": 50, "max_saved_boms": 25, "monitored_parts_limit": 0, "team_features": False, "api_access": False, "student_watermark": True, "price": "$0", "upgrade_to": "Professional", "description": "For verified students and academic projects."},
